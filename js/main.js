...
function homeVideoposition() {
    $('.home').find('.fluid-width-video-wrapper').css({
        "padding-top":"0"
    });
...
var home_video_wrapper_class = $('.home').find('.fluid-width-video-wrapper');
home_video_wrapper_class.removeClass('fluid-width-video-wrapper');
...
function breakingNewsCarousel(){
    ...
    // Activate Carousel
    BreakingNewsCarousel.carousel("pause").removeData();
    BreakingNewsCarousel.carousel(target_slide_index);
...
function homecarouselClassAddition(){
    var firstitemslide = $('.carousel-inner .item:first');
    firstitemslide.addClass('active');
}
