...
@package subhasishlive theme
	...
	========================
*/
add_action( 'wp_ajax_nopriv_sunset_load_more_khala', 'sunset_load_more_khala' );
add_action( 'wp_ajax_sunset_load_more_khala', 'sunset_load_more_khala' );
function sunset_load_more_khala() {
