...
@package subhasishlive theme
	...
	========================
*/
add_action( 'wp_ajax_nopriv_sunset_load_more_kolkata', 'sunset_load_more_kolkata' );
add_action( 'wp_ajax_sunset_load_more_kolkata', 'sunset_load_more_kolkata' );
function sunset_load_more_kolkata() {
	...
	global $tenposts_before_loadmore;
        ...
        'post_status'    => 'publish',
		'paged' => $paged,
		'post__not_in'=>$tenposts_before_loadmore,
		'posts_per_page' => '10'
	) );
