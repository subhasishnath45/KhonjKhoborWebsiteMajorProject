...
@package subhasishlive theme
	...
	========================
*/
add_action( 'wp_ajax_nopriv_sunset_load_more_southbengal', 'sunset_load_more_southbengal' );
add_action( 'wp_ajax_sunset_load_more_southbengal', 'sunset_load_more_southbengal' );
function sunset_load_more_southbengal() {
