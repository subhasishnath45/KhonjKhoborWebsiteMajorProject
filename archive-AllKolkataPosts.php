...
<div id="kolkata-home-posts" class="kolkata-home-posts">
        ...
        ?>
            ...
            <div id="fh5co-main" class="range range-xs-justify sunset-posts-container" data-columns>
          <?php 
            global $tenposts_before_loadmore; 
            $args = array(
                'post_type' => 'AllKolkataPosts',
                'order' => 'DESC',
                'post_status'    => 'publish',
                ...
                // 'paged' => count($first_five_kichenposts_ids),
                'posts_per_page' => '15'
                );
          ...
          ?>
              ...
              // echo $t_slug;
              $tenposts_before_loadmore[] = get_the_ID();
               ?>
            <?php endwhile; ?>
            <?php wp_reset_query(); ?>
            <?php endif;?>
        ...
        <script type="text/javascript">
          ...
          $.ajax({
              ...
              data : {
                  ...
                  page : page,
                  action: 'sunset_load_more_kolkata'
