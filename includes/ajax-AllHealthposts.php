...
@package subhasishlive theme
	...
	========================
*/
add_action( 'wp_ajax_nopriv_sunset_load_more_lifestyle', 'sunset_load_more_lifestyle' );
add_action( 'wp_ajax_sunset_load_more_lifestyle', 'sunset_load_more_lifestyle' );
function sunset_load_more_lifestyle() {
