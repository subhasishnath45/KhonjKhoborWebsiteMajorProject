...
@package subhasishlive theme
	...
	========================
*/
add_action( 'wp_ajax_nopriv_sunset_load_more_tech', 'sunset_load_more_tech' );
add_action( 'wp_ajax_sunset_load_more_tech', 'sunset_load_more_tech' );
function sunset_load_more_tech() {
	

	$paged = $_POST["page"]+2;

		$query = new WP_Query( array(
		'post_type' => 'AllTechPosts',
        'order' => 'DESC',
        'post_status'    => 'publish',
		'paged' => $paged,
		'posts_per_page' => '10'
