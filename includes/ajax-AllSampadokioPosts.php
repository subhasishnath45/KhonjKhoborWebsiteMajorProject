...
@package subhasishlive theme
	...
	========================
*/
add_action( 'wp_ajax_nopriv_sunset_load_more_sampadokio', 'sunset_load_more_sampadokio' );
add_action( 'wp_ajax_sunset_load_more_sampadokio', 'sunset_load_more_sampadokio' );
function sunset_load_more_sampadokio() {
	

	$paged = $_POST["page"]+2;

		$query = new WP_Query( array(
		'post_type' => 'AllSampadokioPosts',
        'order' => 'DESC',
        'post_status'    => 'publish',
		'paged' => $paged,
		'posts_per_page' => '10'
