...
@package subhasishlive theme
	...
	========================
*/
add_action( 'wp_ajax_nopriv_sunset_load_more_offbeat', 'sunset_load_more_offbeat' );
add_action( 'wp_ajax_sunset_load_more_offbeat', 'sunset_load_more_offbeat' );
function sunset_load_more_offbeat() {
	

	$paged = $_POST["page"]+2;

		$query = new WP_Query( array(
		'post_type' => 'AllOffbeatPosts',
        'order' => 'DESC',
        'post_status'    => 'publish',
		'paged' => $paged,
		'posts_per_page' => '10'
